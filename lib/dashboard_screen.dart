...
class _DashboardScreenState
  ...
  Future<void> _loadAll() async {
    ...
    _workedOutToday =
        prefs.getBool('workedOutToday') ?? false;
    ...
    final lastDateString =
        prefs.getString('lastWorkoutDate');
    ...
    final savedDays =
        prefs.getStringList('workoutDays');

    if (savedDays != null) {
      _workoutDays =
          savedDays.map((e) => int.parse(e)).toList();
    }
